    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class="flex w-screen">
                <div class="flex-none w-56 h-screen bg-gray-500">
                ...
                <div class="grow h-screen flex flex-col">
                    <div class="w-full h-14 border-b-4 bg-[#242831] border-gray-300 text-white"><div class="text-xl p-3">{"💬 Chat!"}</div></div>
                    <div class="w-full grow overflow-auto border-b-4 bg-[#242831] border-gray-300">
                        {
                    ...
                    <div class="w-full h-14 flex px-3 items-center bg-[#242831]">
